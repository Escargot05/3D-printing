...
// DZ
#define CUSTOM_MACHINE_NAME "Ender-3-DX"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
// DZ
#define MACHINE_UUID "57fc8763-7bcd-4148-8336-ef56fa37c1b8"
...
//#define ELECTROMAGNETIC_SWITCHING_TOOLHEAD
  ...
  #define SWITCHING_TOOLHEAD_X_POS          { 215, 0 }  // (mm) X positions for parking the extruders
    ...
    //#define PRIME_BEFORE_REMOVE                       // Prime the nozzle before release from the dock
      ...
      #define SWITCHING_TOOLHEAD_ _MM         10  // (mm)   Retract after priming length
 ...
 */
  ...
  // DZ
  #define MPC_BLOCK_HEAT_CAPACITY { 13.8300f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2390f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0994f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
 ...
 */
// DZ
#define NOZZLE_TO_PROBE_OFFSET { -46, -5.5, -0.6 }
...
// DZ 
// Size shrinked due to hero me adapter
...
// DZ - HW PWM has conflict with buzzer?
#define FAN_SOFT_PWM
