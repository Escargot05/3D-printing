...
#define ASSISTED_TRAMMING
  ...
  // DZ
  #define TRAMMING_POINT_XY { { 30, 30 }, { 190, 30 }, { 190,  205 }, { 30, 205 } }
...
//#define INPUT_SHAPING_Z
    ...
    // DZ
    #define SHAPING_FREQ_X  30.98        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.15       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    // DZ
    #define SHAPING_FREQ_Y  32.50        // (Hz) The default dominant resonant frequency on the Y axis.
